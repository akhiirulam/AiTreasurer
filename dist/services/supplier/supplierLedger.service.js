...
const supplierLedger_repository_1 = __importDefault(require("../../repositories/supplier/supplierLedger.repository"));
class SupplierLedgerService {
    // =====================================================
    // GET SUPPLIER LEDGER
    // =====================================================
    async getSupplierLedger(userId, supplierId, from, to) {
        // ===================================================
        // 1. VALIDATE USER ID
        // ===================================================
        ...
        // ===================================================
        const transactions = await supplierLedger_repository_1.default.findSupplierTransactions(userId, supplierId, from, to);
        // ===================================================
        // 7. CALCULATE TOTALS
        // ===================================================
...
exports.default = new SupplierLedgerService();
