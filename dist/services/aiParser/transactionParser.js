...
`;
        ...
        for (const transaction of parsed.transactions) {
            ...
            if (!validAccountTypes.includes(transaction.debitAccountType)) {
                throw new Error(`Invalid debit account type: ${transaction.debitAccountType}`);
            }
            ...
            if (!validAccountTypes.includes(transaction.creditAccountType)) {
                throw new Error(`Invalid credit account type: ${transaction.creditAccountType}`);
            }
            ...
            if (!transaction.creditAccountSubCategory) {
                throw new Error("Invalid transaction: creditAccountSubCategory missing");
            }
        }
        return parsed.transactions;
    }
}
exports.default = new TransactionParserService();
