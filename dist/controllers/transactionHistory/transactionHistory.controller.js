...
const transactionHistory_service_1 = __importDefault(require("../../services/transactionHistory/transactionHistory.service"));
class TransactionHistoryController {
    async getTransactions(req, res, next) {
        try {
            ...
            // 4. DATE CONVERSION
            // ==========================================
            const fromDate = from !== undefined ? new Date(`${from}T00:00:00.000Z`) : undefined;
            const toDate = to !== undefined ? new Date(`${to}T23:59:59.999Z`) : undefined;
            // ==========================================
            // 5. DATE VALIDATION
            // ==========================================
            ...
            // 10. GET TRANSACTIONS
            // ==========================================
            const result = await transactionHistory_service_1.default.getTransactions(userId, {
                search,
                type,
                paymentStatus,
                from: fromDate,
...
exports.default = new TransactionHistoryController();
